...
def run_mike12(): #importar esta función para la interfaz gráfica
    global saludo
    global chiste
    global refranes
    ...
    if "bonito" in rec:   #dime algo bonito
        talk("Maquina, fiera, jefe, tifón, numero 1, figura, monstruo, mastodonte, toro, furia, ciclón, tornado, artista, fenómeno, campeón, maestro, torero, socio")
    ...
    if "qué asignaturas te gustan?" in rec:
    ...
    if "te gusta ser un asistente virtual" in rec:
        talk("Nací para esto")
